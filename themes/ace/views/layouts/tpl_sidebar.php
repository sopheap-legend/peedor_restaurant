    ...
    'items' => array(
            ...
            array('label'=>'<span class="menu-text">' . strtoupper(Yii::t('app', 'Report')) .'</span>', 'icon'=>'menu-icon fa fa-signal', 'url'=>Yii::app()->urlManager->createUrl('report/reporttab'),
                ...
                'items'=>array(
                    ...
                    array('label'=>Yii::t('app','Daily GiftCard Used'),'icon'=> 'menu-icon fa fa-caret-right', 'url'=>Yii::app()->urlManager->createUrl('report/dailyGiftcard'),
                        'active'=>$this->id .'/'. $this->action->id =='report/dailyGiftcard'
                    ),
