...
class ReportColumn extends CModel
{
    ...
    public static function getItemsColumns()
    {
        return array(
            array(
                'class' => 'yiiwheels.widgets.grid.WhRelationalColumn',
            ...
            array(
                'name' => 'item_id',
                'header' => Yii::t('app', 'Item ID'),
                'value' => '$data["item_id"]',
                'visible'=>false
            ),
            array(
                'name' => 'line',
                'header' => Yii::t('app', 'Item Line'),
                'value' => '$data["line"]',
                'visible'=>false
            ),
            array(
                'name' => 'item_parent_id',
                'header' => Yii::t('app', 'Parent ID'),
                'value' => '$data["item_parent_id"]',
                'visible'=>false
            ),
            array(
                'name' => 'category_id',
                'header' => Yii::t('app', 'category_id'),
            ...
            array(
                ...
                'value' => '$data["item_number"]',
                //'class' => 'yiiwheels.widgets.grid.WhRelationalColumn',
                //'url' => Yii::app()->createUrl("saleItem/ShowItemsDetail"),
            ),
            array(
                'name' => 'name',
                'header' => Yii::t('app', 'Item Name'),
            ...
            /*array('class' => 'bootstrap.widgets.TbButtonColumn',
                ...
                'buttons' => array(
                    'detail' => array(
                        //'click' => 'updateDialogOpen',
                        'label' => 'Detail',
                        'url' => 'Yii::app()->createUrl("saleItem/ShowItemsDetail/",array("item_id" => $data["item_id"], "category_id" => $data["category_id"]))',
                        'options' => array(
                            //'data-update-dialog-title' => Yii::t('app', 'Item Detail'),
    ...
    public static function getDetailItemsColumns($view='index')
    {
        return array(
            /*array('name' => 'item_id',
                'header' => Yii::t('app', 'item_id'),
                'value' => '$data["item_id"]',
            ),array('name' => 'line',
            ...
            array(
                ...
                'header' => 'Action',
                'template'=>'<div class="btn-group">{cancel}</div>',
                'buttons' => array(
                    /*'add' => array(
                        'url' => 'Yii::app()->createUrl("Item/SelectItem/",
                            array("item_parent_id" => $data["item_id"], 
                        ...
                        'options' => array(
                            //'target' => '_blank',
                            'class' => 'update-dialog-open-link btn btn-xs btn-success',
                    ...
                    'cancel' => array(
                        'label' => 'delete',
                        'icon' => 'fa fa-trash-o',
                        'url' => 'Yii::app()->createUrl("saleItem/DeleteItem",array(
