    ...
    <div class="widget-main padding-12">
        ...
        <?php  foreach ($tables as $table) { ?>
            <?php if ($table["id"]==$table_id) { ?>
                 <a class="btn btn-white btn-success btn-round table-btn active btn-lg" href="<?php echo Yii::app()->createUrl('saleItem/SetTable/',array('table_id'=>$table['id'],'view'=>$view)); ?>">
            ...
            <?php } elseif ($table["busy_flag"]==0) { ?>
                <?php echo TbHtml::linkButton($table['name'],array(
                    ...
                    'url'=>Yii::app()->createUrl('saleItem/SetTable/',array('table_id'=>$table['id'],'view'=>$view)),
