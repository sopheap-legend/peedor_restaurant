...
class OrderingCart extends CApplicationComponent
{
    ...
    public function getCartCashier()
    {
        //$cart=array();
        //$cart = SaleOrder::model()->getOrderCart($this->getSaleId(), Common::getCurLocationID());
        $cart = SaleOrder::model()->getOrderCartCashier($this->getTableId(), $this->getGroupId(),Common::getCurLocationID());
    ...
    public function getCartCashierGrid($item_id=null)
    {
        //$cart=array();
        //$cart = SaleOrder::model()->getOrderCart($this->getSaleId(), Common::getCurLocationID());
        $cart = SaleOrder::model()->getOrderCartGrid($this->getTableId(), $this->getGroupId(),Common::getCurLocationID(),$item_id);
